...
from requests.user_requests import UserRegisterRequest, UserLoginRequest, UserIdRequest
...
async def get_user_by_id(request: UserIdRequest):
    user = await getUserByIdService(request.user_id)
